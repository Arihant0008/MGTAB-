...
class GraphSAGE(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = SAGEConv(num_features, 256)
...
best_val = 0
best_path = "best_graphsage.pt"

# ------------------------
# 4. LOG FILE SETUP
# ------------------------
log_path = "logs\graphsage_training_log.csv"
...
print("\nBest Val Accuracy (GraphSAGE):", best_val)
...
print("GraphSAGE Bot Recall:", bot_recall)
