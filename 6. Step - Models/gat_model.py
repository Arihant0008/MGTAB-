...
class GAT(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = GATConv(num_features, 128, heads=2)  # 128 * 2 = 256
        self.conv2 = GATConv(256, num_classes, heads=1)
...
best_val = 0
best_path = "best_gat.pt"

# ------------------------
# 4. LOG FILE SETUP
# ------------------------
log_path = "logs\gat_training_log.csv"
...
print("\nBest Val Accuracy (GAT):", best_val)
...
print("GAT Bot Recall:", bot_recall)
